...
#ifdef WIN32
static const char* default_config_file = "ascnhalf-realmserver.conf";
static const char* default_realm_config_file = "ascnhalf-realms.conf";
#else
static const char* default_config_file = CONFDIR "/ascnhalf-realmserver.conf";
...
bool Master::Run(int argc, char ** argv)
{
	...
	/* write pid file */
	FILE * fPid = fopen( "realmserver.pid", "w" );
	if( fPid )
	{
		uint32 pid;
#ifdef WIN32
