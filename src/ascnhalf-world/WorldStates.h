...
/*	WORLDSTATE_IOC_ALLIANCE_SCORE_DISPLAY
	WORLDSTATE_IOC_HORDE_SCORE_DISPLAY*/
	WORLDSTATE_IOC_ALLIANCE_EAST_GATE					= 4326,
	WORLDSTATE_IOC_ALLIANCE_GATE_DESTROYED_1			= 4323,		// wich gate is it?
	WORLDSTATE_IOC_ALLIANCE_GATE_DESTROYED_2			= 4325,		// wich gate is it?
	WORLDSTATE_IOC_ALLIANCE_GATE_DESTROYED_3			= 4324,		// wich gate is it?
	WORLDSTATE_IOC_ALLIANCE_WEST_GATE					= 4327,
	WORLDSTATE_IOC_ALLIANCE_FRONT_GATE					= 4328,
	// Prometheusz: coming soon...
/*	WORLDSTATE_IOC_ALLIANCE_KEEP
	WORLDSTATE_IOC_ALLIANCE_KEEP
	WORLDSTATE_IOC_ALLIANCE_KEEP
	WORLDSTATE_IOC_ALLIANCE_KEEP
	WORLDSTATE_IOC_ALLIANCE_KEEP
	WORLDSTATE_IOC_HORDE_KEEP
	WORLDSTATE_IOC_HORDE_KEEP
	WORLDSTATE_IOC_HORDE_KEEP
	WORLDSTATE_IOC_HORDE_KEEP
	WORLDSTATE_IOC_HORDE_KEEP
	WORLDSTATE_IOC_DOCKS
	WORLDSTATE_IOC_DOCKS
	WORLDSTATE_IOC_DOCKS
	WORLDSTATE_IOC_DOCKS
	WORLDSTATE_IOC_DOCKS
	WORLDSTATE_IOC_HANGAR
	WORLDSTATE_IOC_HANGAR
	WORLDSTATE_IOC_HANGAR
	WORLDSTATE_IOC_HANGAR
	WORLDSTATE_IOC_HANGAR
	WORLDSTATE_IOC_QUARRY
	WORLDSTATE_IOC_QUARRY
	WORLDSTATE_IOC_QUARRY
	WORLDSTATE_IOC_QUARRY
	WORLDSTATE_IOC_QUARRY
	WORLDSTATE_IOC_REFINERY
	WORLDSTATE_IOC_REFINERY
	WORLDSTATE_IOC_REFINERY
	WORLDSTATE_IOC_REFINERY
	WORLDSTATE_IOC_REFINERY
	WORLDSTATE_IOC_WORKSHOP
	WORLDSTATE_IOC_WORKSHOP
	WORLDSTATE_IOC_WORKSHOP
	WORLDSTATE_IOC_WORKSHOP
	WORLDSTATE_IOC_WORKSHOP
	WORLDSTATE_IOC_HORDE_EAST_GATE					=
	WORLDSTATE_IOC_HORDE_GATE_DESTROYED_1			= 		// wich gate is it?
	WORLDSTATE_IOC_HORDE_GATE_DESTROYED_2			= 		// wich gate is it?
	WORLDSTATE_IOC_HORDE_GATE_DESTROYED_3			= 		// wich gate is it?
	WORLDSTATE_IOC_HORDE_WEST_GATE					= 
	WORLDSTATE_IOC_HORDE_FRONT_GATE			
	*/
};
