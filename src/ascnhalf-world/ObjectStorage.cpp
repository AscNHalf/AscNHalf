...
const char * gCreatureProtoFormat						= "uuuuuucufuuuffuffuuuuuuuuuuuffsuiibuufffuuicuuuuuuuu";
...
const char * gItemPrototypeFormat						= "uuuussssuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuffuffuuuuuuuuuufuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuusuuuuuuuuuuuuuuuuuuuuuuuuuubuuu";
...
void Storage_FillTaskList(TaskList & tl)
{
	...
	tl.AddTask(new Task(new CallbackP2<SQLStorage< MapInfo, ArrayStorageContainer<MapInfo> >, std::string, const char*>(&WorldMapInfoStorage, &SQLStorage< MapInfo, ArrayStorageContainer<MapInfo> >::Load, worldmap_info, gWorldMapInfoFormat)));
	//make_task(WorldMapInfoStorage, MapInfo, ArrayStorageContainer, worldmap_info.c_str(), gWorldMapInfoFormat);
...
bool LoadAdditionalTable(const char * TableName, const char * SecondName)
{
	...
	else if(!stricmp(TableName, Config.MainConfig.GetStringDefault("Cluster", "MapInfoTable", "worldmap_info").c_str()))		// WorldMapInfo
...
bool Storage_ReloadTable(const char * TableName)
{
	...
	else if(!stricmp(TableName, Config.MainConfig.GetStringDefault("Cluster", "MapInfoTable", "worldmap_info").c_str()))
