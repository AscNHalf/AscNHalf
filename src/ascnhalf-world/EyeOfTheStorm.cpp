...
void EyeOfTheStorm::OnCreate()
{
	...
	for( i = 0; i < 2; ++i )
	{
		...
		m_bubbles[i]->SetUInt32Value(GAMEOBJECT_DYNAMIC, 4294901760);
		m_bubbles[i]->SetUInt32Value(GAMEOBJECT_FACTION, 1375);
		m_bubbles[i]->SetUInt32Value(GAMEOBJECT_BYTES_1, 4278190081);
	...
	m_dropFlag->SetUInt32Value(GAMEOBJECT_DYNAMIC, 1);
