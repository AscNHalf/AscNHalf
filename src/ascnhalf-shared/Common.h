...
#  define NOMINMAX
#  define ASCENT_DEPRECATED __declspec(deprecated("This function, class or enum is deprecated. Check, re-implement or remove it!"))
#  include <windows.h>
#else
#  include <string.h>
#  define ASCENT_DEPRECATED
...
#	define UNORDERED_MULTIMAP	boost::unordered_multimap
